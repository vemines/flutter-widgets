      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("AppBar - Custom Background Color",
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child:
                  Text("AppBar - Custom Text Style", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            SizedBox(
              height: 150,
              child: Scaffold(
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("AppBar - With Bottom Widget",
                  style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            SizedBox(
              height: 150,
              child: Scaffold(
                appBar: AppBar(
                  title: Text("Bottom with PreferredSize Widget"),
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child:
                  Text("AppBar - With Shadow Color", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            SizedBox(
              height: 150,
              child: Scaffold(
