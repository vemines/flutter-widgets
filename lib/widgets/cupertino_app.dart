      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            CupertinoApp(
              home: Center(child: Text("Basic CupertinoApp")),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("CupertinoApp - With Theme", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            CupertinoApp(
              theme: CupertinoThemeData(
                primaryColor: CupertinoColors.activeBlue,
              ),
              home: Center(child: Text("Themed CupertinoApp", style: TextStyle(color: CupertinoColors.white))),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("CupertinoApp - With Title", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            CupertinoApp(
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("CupertinoApp - With Routes", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            CupertinoApp(
              routes: {
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("CupertinoApp - With OnGenerateRoute", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            CupertinoApp(
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("CupertinoApp - With Initial Route", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            CupertinoApp(
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("CupertinoApp - With Builder", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            CupertinoApp(
