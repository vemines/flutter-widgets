      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text("ShaderMask Variations:",
                ...
                children: [
                  _buildShaderMaskVariation(
                      ...
                      ShaderMask(
                        ...
                        child: const Text('Hello ShaderMask',
                            style: TextStyle(fontSize: 24, color: Colors.white)),
                      ),
                      'ShaderMask with a linear gradient.'),
                  _buildShaderMaskVariation(
                  ...
                  _buildShaderMaskVariation(
                      ...
                      ShaderMask(
                        ...
                        child: const Text('BlendMode.dstATop',
                  ...
                  _buildShaderMaskVariation(
                      ...
                      ShaderMask(
                        ...
                        child: const Text('BlendMode.multiply',
                            style: TextStyle(fontSize: 20, color: Colors.white)),
                      ),
