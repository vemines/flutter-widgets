      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text("AnimatedSize Variations:",
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              const SizedBox(height: 20),
              const Text("AnimatedSize - Example", style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
              _AnimatedSizeExample(),
              const SizedBox(height: 20),
              const Text("AnimatedSize - With Container",
                  style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
              _AnimatedSizeWithContainer(),
              const SizedBox(height: 20),
              const Text("AnimatedSize - Different Duration",
                  style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
              _AnimatedSizeDuration(),
              const SizedBox(height: 20),
              const Text("AnimatedSize - Different Curve",
                  style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
              _AnimatedSizeCurve(),
              const SizedBox(height: 20),
              const Text("AnimatedSize - Different Alignment",
                  style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
